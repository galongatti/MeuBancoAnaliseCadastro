...
using MeuBancoConsumerAnaliseCadastro.Service;
...
namespace MeuBancoConsumerAnaliseCadastro;
...
public class Worker : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        {
            Uri = new Uri(_uri),
            ClientProvidedName = "Analise Cadastro Receiver App"
        };
        ...
        consumer.Received += (sender, args) =>
        {
            ...
            if (emprestimo != null)
            {
                ...
                emprestimo = service.AvaliarRenda(emprestimo);
